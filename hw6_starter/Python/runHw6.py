...
def challenge1a():
    ...
    _, gray_stack = loadFocalStack(focal_stack_dir)
    ...
    Image.fromarray(((index_map)).astype(np.uint8)).save('outputs/indx.png')
...
def challenge1b():
    ...
    focal_stack_dir = 'data/stack'
    rgb_stack, _ = loadFocalStack(focal_stack_dir)

    index_map = np.array(Image.open('outputs/indx.png'))
